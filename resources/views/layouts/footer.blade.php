        ...
        <div class="row row-30">
            <div class="col-md-6">
                <div class="pr-xl-4">
                    ...
                    <!-- Rights-->
                    <p class="rights"><span>&copy; </span><span class="copyright-year">2022</span><span> </span><span> - </span><span>All Rights Reserved.</span></p>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <h5>Contacts</h5>
                    ...
                    <dl class="contact-list">
                        <dt>email:</dt>
                        <dd><a href="mailto:#">aastha.subrata@gmail.com</a></dd>
                    </dl>
                    <dl class="contact-list">
                        <dt>phones:</dt>
                        <dd>+91 9933671962 <span>or</span> +91 86533 44959</a></dd>
                    </dl>
                </div> 
            </div>
        </div>
