                ...
                <div class="card">
                    <div class="card-header">
                        <span class="float-start">
                            <h4>List of Work Status</h4>
                        </span>
                        <span class="float-end">
                            <a href="{{ route('workstatus.create') }}" class="btn btn-sm btn-outline-primary">Create New Work Status</a>
                        </span>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-sm table-hover table-responsive text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Work Status Short Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('workstatus.edit', $item->id) }}"
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-sm btn-outline-danger rounded-pill"
                                                ...
                                                onclick="event.preventDefault(); populateModal('{{ $item->name }}', '{{ route('workstatus.destroy', $item->id) }}');"
                                                >
