        ...
        <table id="zero_config" class="table table-bordered table-sm table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <i class="m-r-10 mdi mdi-checkbox-blank-circle {{ $language->is_system ? 'text-warning' : 'text-info' }}"></i>
                        {{ $language->is_system ? "Yes" : "No" }}
                    </td>

                    <td class="text-center">
                        <i class="m-r-10 mdi mdi-checkbox-blank-circle {{ $language->trashed() ? 'text-danger' : 'text-success' }}"></i>
