...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Alter</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation"
                            novalidate action="{{ route('user.update', $user->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="location_id[]" multiple size="9"
                                    ...
                                    <option value="{{ $item->id }}" {{in_array($item->id, old("location_id", $oldLoc) ?: []) ? "selected": ""}}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                                    @error('location_id')
