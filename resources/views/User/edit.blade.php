        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modify User</h4>
                </div>

                <form method="POST" action="{{ route('users.update', $user) }}" class="row g-3 m-2" novalidate>
                    @csrf
